...
export default function FinanceEntreprisePage() {
  ...
  const jobs = getJobsByCareerPath("corp-finance");
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {jobs.map((job, index) => (
            ...
            >
              <Link
                href={`/entretien-ia/simulation?career=corp-finance&job=${job.id}`}
                className="block h-full"
              >
                <div className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-xl hover:border-primary/30 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col">
